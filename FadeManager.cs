	...
	public void OnGUI ()
	{
		...
		if (this.DebugMode) {
			if (!this.isFading) {
                ...
                scenes.Add("mian");
                scenes.Add("cointos");
                scenes.Add("Config_MainMode");
                scenes.Add("Config_MainMode_2_solo");
                scenes.Add("Config_MainMode_standby_Solo");
                scenes.Add("GameOver");
                scenes.Add("Config_PracticeMode");
                scenes.Add("Config_Tutorial");
                scenes.Add("Config_FreePractice");
                scenes.Add("FreePractice");
